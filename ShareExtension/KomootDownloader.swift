...
enum KomootError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .invalidURL: return "Invalid Komoot URL or tour ID."
        case .couldNotFindTourData: return "Could not find tour data. The tour may be private."
        ...
        case .invalidTourData: return "Could not parse tour data."
        case .tourNotFound: return "Tour not found. Check the URL and ensure the tour is public."
        }
    }
}
...
enum KomootDownloader {
    ...
    private static func parseInput(_ input: String) throws -> (tourID: String?, shareToken: String?) {
        ...
        // Check for /smarttour/e12345 or /smarttour/12345 pattern
        ...
        // Some other URL — fall back to page scraping
        return (nil, nil)
    }
    ...
    private static func extractJSON(from html: String) throws -> JSONValue {
        ...
        // Unescape as a JSON string literal
        let quoted = "\"\(captured)\""
